...
const translations = {
  ja: {
    ...
    'dashboard.customFrequencyPrompt': 'カスタムの頻度を入力してください（例: 週3回、隔週など）:',
    'today.title': '今日見る',
    ...
    'routine.completedDays': '実施日: {0}日',
    'routine.noCompletedDaysInMonth': '実施日なし',
    'calendar.addToCalendar': 'Googleカレンダーに追加',
    'calendar.addToCalendarHelp': 'チェックした場合だけ、日付のある目標を終日予定として追加します。',
  ...
  en: {
    ...
    'premium.freeUsage': 'Free plan usage',
    ...
    'dashboard.customFrequencyPrompt': 'Enter a custom frequency (e.g. 3 times a week):',
    'today.title': 'Today',
    ...
    'routine.completedDays': 'Completed: {0}',
    'routine.noCompletedDaysInMonth': 'No completed days',
    'calendar.addToCalendar': 'Add to Google Calendar',
    'calendar.addToCalendarHelp': 'When checked, Orbit adds dated goals as all-day events.',
