...
const translations = {
  ja: {
    ...
    'calendar.addToCalendarHelp': 'チェックした場合だけ、日付のある目標を終日予定として追加します。Routineは開始日〜完了日の繰り返し予定になります。',
    'calendar.dateRequired': 'Googleカレンダーに追加するには、開始日・期限日・完了日のいずれかを入力してください。',
    'calendar.routineDateRequired': 'RoutineをGoogleカレンダーの繰り返し予定にするには、開始日と完了日の両方を入力してください。',
  ...
  en: {
    ...
    'calendar.addToCalendarHelp': 'When checked, Orbit adds dated goals as all-day events. Routines become recurring events from start date to completed date.',
    'calendar.dateRequired': 'Enter a start date, due date, or completed date before adding this goal to Google Calendar.',
    'calendar.routineDateRequired': 'Enter both a start date and completed date to add this routine as a recurring Google Calendar event.',
